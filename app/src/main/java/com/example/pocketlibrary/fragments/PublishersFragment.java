...
public class PublishersFragment extends Fragment {
    ...
    public class CustomViewPager2Adapter extends FragmentStateAdapter{
        ...
        public Fragment createFragment(int position) {
            switch(position){
                case 0: return PublisherFragment.newInstance("Random House", R.drawable.random_house, "Random House is an American book publisher and the largest general-interest paperback publisher in the world. It is part of Penguin Random House, which is owned by German media conglomerate Bertelsmann. ", "https://www.randomhousebooks.com/");
                ...
                case 5: return PublisherFragment.newInstance("Macmillan Publishers", R.drawable.macmillan_publishers, "Macmillan Publishers Ltd (occasionally known as the Macmillan Group) is a British publishing company traditionally considered to be one of the 'Big Five' English language publishers.", "https://us.macmillan.com/");
                case 6: return PublisherFragment.newInstance("Simon & Schuster", R.drawable.simon_schuster, "Simon & Schuster is an American publishing company and a subsidiary of ViacomCBS founded in New York City in 1924 by Richard L. Simon and M. Lincoln Schuster. As of 2016, Simon & Schuster was the third largest publisher in the United States.", "https://www.simonandschuster.com/");
                case 7: return PublisherFragment.newInstance("Penguin Random House", R.drawable.penguin_random, "Penguin Random House LLC is a multinational conglomerate publishing company formed in 2013 from the merger of Penguin Group and Random House.", "https://www.penguinrandomhouse.com/");
